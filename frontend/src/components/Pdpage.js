    ...
    <>
        ...
        <div className='pdpneedtoknows'>
          <div className='pdpmoreimages'>
            ...
            <div className='pdpmoreimages-imgwrapper'> <img className='pdpmainimg' src={data.product.gallery[0]} alt={data.product.name}/></div>
            <div className='pdpmoreimages-imgwrapper'> <img className='pdpmainimg' src={data.product.gallery[0]} alt={data.product.name}/></div>
            
          </div>
          
            <div className='pdpmainimg-wrapper '><img className='pdpmainimg' src={data.product.gallery[0]} alt=''/>
          </div>
          ...
          <div className='pdpnote'>{data.product.description}</div>
          </div>
          </div>
